...
namespace ParallelProcessingProject
{
    public partial class Deposit : Form
    {
        ...
        private readonly SemaphoreSlim semaphore = new SemaphoreSlim(1, 1);// Semaphore take one thread in critical Section to prevent race condition
        //decimal oldBalance 
        decimal newBalance;
        // int Acc = 2 ;
...
*/
        ...
        {
            //Check if semaphore busy or not
            if (!semaphore.Wait(0))
            {
                ...
                using(var connection = new SqlConnection(ConnectionStringProvider.ConnectionString))
                {
                    ...
                    //Insert Transactions Table With New Log
            ...
            {//Invoke Used For UI Responsive by invoking updates on the UI thread
            ...
            {
                semaphore.Release(); // to prevent Deadlock
            }
        }
